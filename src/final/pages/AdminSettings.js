...
export default function AdminSettings() {
    ...
    const {signOut,curUid,updatePass,updateUsername,removeUser}=UserAuth();
                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className={styles["email"]}>
                                ...
                                <input type="email-input" className={styles["email-input"]} value={email} onChange={handleEmailChange}></input>
                            </div>
                            <div className={styles['Password1']}>
                                <label className={styles["p1"]} >Password</label>
                                <input type="password" className={styles["p1-input"]} onChange={handlePassword1Change}></input>
                            </div>
                            <div className={styles['Password2']}>
                                <label className={styles["p2"]} >Re-enter Password</label>
                                <input type="password" className={styles["p2-input"]} onChange={handlePassword2Change}></input>
                            </div>
                        </form>
                        <div className={styles["settingActions"]}>
                            <div>
                                <button className={styles["save"]} onClick={save}>Save & Exit</button>
                            </div>
                            <div>
                                <button className={styles["exit"]} onClick={exit}>Exit Without Saving</button>
                            </div>
                            <div>
                                <button className={styles["delete"]} onClick={remove}>Delete Account</button>
                            </div>
                        </div>
                    </div>
                )}

    ...
    return(
        <>
            <div className={styles["adminHome"]}>
                ...
                <button className={styles["add-artifact"]} onClick={add}>Add New Artifact</button>
                <button className={styles["edit-artifact"]} onClick={update}>Edit an Artifact</button>
                <button className={styles["manage-admins"]} onClick={manage}>Manage Administrators</button>
            </div>
        </>
    )
}